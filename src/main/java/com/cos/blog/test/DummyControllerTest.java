...
public class DummyControllerTest {
	...
	// save 함수는 id를 전달하면 해당 id가 없으면 insert를 해줌
	// email, password
	@Transactional // 함수 종료시에 자동 commit이 됨
	@PutMapping("/dummy/user/{id}")
	public User updateUser(@PathVariable int id, @RequestBody User requestUser) {
		// json 데이터 요청 => Java Object로 변환해서 받아줌
		// (Message Converter의 Jackson 라이브러리가 변환해주는거)
...
//		userRepository.save(requestUser); // 기존의 값에 save 해줌 , 그러나 안넣은값은 null이됨
